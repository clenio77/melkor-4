"""
Django settings for Melkor 3.0 project.
...
SECRET_KEY = config('SECRET_KEY', default='melkor-dev-key-change-in-production')
...
WSGI_APPLICATION = 'melkor_project.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'melkor_dev.sqlite3',
    }
}
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'melkor.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
